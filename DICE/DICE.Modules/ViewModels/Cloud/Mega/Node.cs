namespace DICE.Modules.ViewModels.Cloud.Mega
{
  ...
  internal class Node : INode, INodeCrypto
  {
	...
	[JsonIgnore]
	public string Fav => Attributes?.Fav;

	[JsonIgnore]
	public string Lbl => Attributes?.Lbl;

	[JsonProperty("r")]
	public string SharingType { get; private set; }
  ...
  internal class PublicNode : INode, INodeCrypto
  {
	...
	public string Fav => _node.Fav;
	public string Lbl => _node.Lbl;
	public string SharingType => _node.SharingType;
	public string SharedUserId => _node.SharedUserId;
