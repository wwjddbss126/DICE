...
namespace DICE.Modules.ViewModels.Cloud.Mega
{
  ...
  public class WebClient : IWebClient
  {
    ...
    public WebClient(int responseTimeout = DefaultResponseTimeout, ProductInfoHeaderValue userAgent = null)
    {
      ...
      {
        throw new NotSupportedException("mega.nz API requires support for TLS v1.2 or higher. Check https://gpailler.github.io/MegaManager/#compatibility for additional information");
      }
#elif NET45 || NET46
