namespace DICE.Modules.ViewModels.Cloud.Mega
{
  ...
  {
    public static long GetFolderSize(this INode node, IMegaManager client)
    {
    ...
    public static async Task<long> GetFolderSizeAsync(this INode node, IMegaManager client)
    {
